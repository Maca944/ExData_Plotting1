...
png(filename="plot4.png", width = 480, height = 480) # generate the .png file
...
plot(hpc$DateTime, hpc$Sub_metering_1, 
     type = "l",
     xlab = "",
     ylab = "Energy sub metering") # name the y-axis,  
lines(hpc$DateTime, hpc$Sub_metering_2, col = "red") #add the second line
lines(hpc$DateTime, hpc$Sub_metering_3, col = "blue") # and the third
legend('topright', c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty = 1, bty="n") 
#and add a legend with the correct colors, without the box around the legend this time

plot(hpc$DateTime, hpc$Global_reactive_power,
     type = "l",
     xlab = "datetime",
     ylab = "Global_reactive_power", # name the y-axis
     ylim = c(0.0,0.5))
